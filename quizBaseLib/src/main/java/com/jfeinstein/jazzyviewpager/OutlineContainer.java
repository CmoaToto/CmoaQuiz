...
public class OutlineContainer extends FrameLayout implements Animatable {
    ...
    private void init() {
        ...
        mOutlinePaint.setStrokeWidth(DimenUtils.dpToPx(getContext(), 2));
        mOutlinePaint.setColor(getResources().getColor(R.color.holo_blue_light));
        mOutlinePaint.setStyle(Style.STROKE);

        int padding = DimenUtils.dpToPx(getContext(), 10);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int offset = DimenUtils.dpToPx(getContext(), 5);
